...
This wraps ``hammock.engine.runner.run_job`` so the dashboard's
...
from hammock.engine.runner import JobConfig, run_job
...
def _fake_runner(
    ...
    """Stub runner used when HAMMOCK_RUNNER_MODE=fake.
