...
def test_create_user_workflow(client: TestClient, hammock_v2_root: Path) -> None:
    yaml_text = """
name: my-test
...
"""
    ...
    user_path = hammock_v2_root / "workflows" / "my-test.yaml"
...
def test_update_user_workflow(client: TestClient, hammock_v2_root: Path) -> None:
    user_dir = hammock_v2_root / "workflows"
...
def test_delete_user_workflow(client: TestClient, hammock_v2_root: Path) -> None:
    user_dir = hammock_v2_root / "workflows"
    user_dir.mkdir(exist_ok=True)
...
def test_user_workflow_usable_for_submit(client: TestClient, hammock_v2_root: Path) -> None:
